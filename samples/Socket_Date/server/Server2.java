package br.com.berkleysocket.samples.Socket_Date.server;
...
// SERVER : Single ServerView
// Tipe : One-Way Communication (ServerView to Client)
// Description : Return the current date of ServerView every 1 second to client
